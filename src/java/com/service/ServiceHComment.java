...
import com.exam.service.HighlightsCommentService;
 ...
 * @author shaarif
 */
@Path("/highlightscomment")
@Consumes(MediaType.APPLICATION_JSON)
@Produces(MediaType.APPLICATION_JSON)
public class ServiceHComment {
     HighlightsCommentService simpleService = new HighlightsCommentService();
    ...
    public List<Commenthighlights> getAllStudent() {
       ...
       @POST
    public Commenthighlights addStudent(Commenthighlights s){
